...
import { Tag, Search, Plus, Download, Edit, Trash2 } from 'lucide-react';
import DataTableWithExport from '@/components/DataTableWithExport';

export default function Edu_CategoriesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { key: 'nama_kategori', label: 'Nama Kategori' }, { key: 'jumlah_konten', label: 'Jumlah Konten' }, { key: 'status', label: 'Status' }, { key: 'aksi', label: 'Aksi' }
  ];
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Kategori & Tag</h1>
          <p className="text-slate-600 mt-1">Kelola kategori dan tag untuk konten edukasi</p>
        </div>
