...
import { FileStack, Search, Plus, Download, Edit, Trash2 } from 'lucide-react';
import DataTableWithExport from '@/components/DataTableWithExport';

export default function Edu_ReferencesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { key: 'judul', label: 'Judul' }, { key: 'penulis', label: 'Penulis' }, { key: 'tahun', label: 'Tahun' }, { key: 'jurnal', label: 'Jurnal' }, { key: 'aksi', label: 'Aksi' }
  ];
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Referensi Literatur</h1>
          <p className="text-slate-600 mt-1">Kelola database referensi literatur dan publikasi</p>
        </div>
