...
export default function Mythbuster_NewPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-slate-900">Tambah Mitos Baru</h1>
        <p className="text-slate-600 mt-1">Tambahkan entri mitos vs fakta baru</p>
      </div>
