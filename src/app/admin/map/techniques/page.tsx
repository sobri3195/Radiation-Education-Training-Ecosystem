...
import { Target, Search, Plus, Download, Edit, Trash2 } from 'lucide-react';
import DataTableWithExport from '@/components/DataTableWithExport';

export default function Map_TechniquesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { key: 'teknik', label: 'Teknik' }, { key: 'indikasi', label: 'Indikasi' }, { key: 'keunggulan', label: 'Keunggulan' }, { key: 'keterbatasan', label: 'Keterbatasan' }
  ];
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Teknik & Modalitas Radiasi</h1>
          <p className="text-slate-600 mt-1">Database teknik radioterapi: IMRT, VMAT, 3D-CRT, SBRT</p>
        </div>
