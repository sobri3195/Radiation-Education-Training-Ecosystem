...
import { Key, Search, Plus, Download, Edit, Trash2 } from 'lucide-react';
import DataTableWithExport from '@/components/DataTableWithExport';

export default function Oncocase_KeysPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { key: 'kasus', label: 'Kasus' }, { key: 'pertanyaan', label: 'Pertanyaan' }, { key: 'jawaban_benar', label: 'Jawaban Benar' }, { key: 'poin', label: 'Poin' }
  ];
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Kunci Jawaban & Skor</h1>
          <p className="text-slate-600 mt-1">Kelola kunci jawaban dan sistem penskoran kasus</p>
        </div>
