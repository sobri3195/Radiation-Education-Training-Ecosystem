...
export default function Simudose_TemplatesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { key: 'nama_template', label: 'Nama Template' }, { key: 'jenis_kanker', label: 'Jenis Kanker' }, { key: 'fraksi', label: 'Fraksi' }, { key: 'dosis/fraksi', label: 'Dosis/Fraksi' }
  ];
    ...
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <DataTableWithExport
          ...
          exportFileName="simudose-templates"
        />
      </div>
    </div>
  );
